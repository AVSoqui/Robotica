...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{potenciometro.png} % Ajusta el tamaño
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{LVDT.png} % Ajusta el tamaño
	\caption{Sensor LVDT}
	\label{fig:ejemplo3}
\end{figure}
\vspace{2cm}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{resolver.jpeg} % Ajusta el tamaño
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{EfectoHall.jpg} % Ajusta el tamaño
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{galga.png} % Ajusta el tamaño
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{piezoelectrico.jpg} % Ajusta el tamaño
